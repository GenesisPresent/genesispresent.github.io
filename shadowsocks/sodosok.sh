...
thvpn="genesispresent.github.io/shadowsocks"
...
echo "#############################################"
echo "Settings Shadowsocks-libev"
...
cd /usr/bin
wget -O addss "https://${thvpn}/addss.sh"
wget -O delss "https://${thvpn}/delss.sh"
wget -O cekss "https://${thvpn}/cekss.sh"
wget -O renewss "https://${thvpn}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
