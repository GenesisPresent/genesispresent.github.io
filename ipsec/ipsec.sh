...
thvpn="genesispresent.github.io/ipsec"
VPN_IPSEC_PSK='thvpn'
...
wget -O /usr/bin/addl2tp https://${thvpn}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${thvpn}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${thvpn}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${thvpn}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${thvpn}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${thvpn}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
touch /var/lib/thvpn/data-user-l2tp
touch /var/lib/thvpn/data-user-pptp
rm -f /root/ipsec.sh
