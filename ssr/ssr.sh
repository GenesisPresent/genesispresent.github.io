...
thvpn="genesispresent.github.io/ssr"
...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://${thvpn}/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://${thvpn}/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://${thvpn}/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://${thvpn}/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/renewssr https://${thvpn}/renewssr.sh && chmod +x /usr/bin/renewssr
